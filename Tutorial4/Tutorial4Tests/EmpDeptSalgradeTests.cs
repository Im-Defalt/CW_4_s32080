...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldCountEmployeesPerDepartment()
    {
        ...
        var result = emps.GroupBy(emp => emp.DeptNo).Select(e => new {DeptNo = e.Key, Count = e.Count()});
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = emps.Where(e => e.Comm is not null).Select(e => new {e.EName, e.Comm}).ToList(); 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps.Join(
            ...
            (emp, grade) => new
            {
                ...
                obj.emp.Sal >= obj.grade.Losal && obj.emp.Sal <= obj.grade.Hisal).Select(obj => new
        {
            obj.emp.EName,
            obj.grade.Grade
        });
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(e => e.Sal > emps.Where(f => f.DeptNo == e.DeptNo).Average(e => e.Sal)).Select(e => e.EName).ToList(); 
